...
public class GetHttpKdmThread2 extends AbstractProcessor {
	...
	public String getUrl(ProcessContext processContext, String batchCode) {
	...
	public void splitCode(ProcessContext processContext, int CodeCount) {
	...
	public String getURLContent(String url2) throws IOException {
